...
merged_df["Profit"] = merged_df["Price_Canada"] - merged_df["Price_USA"]
merged_df["Profit_Percentage"] = merged_df["Profit"] / merged_df["Price_USA"] * 100
...
profitable_products.sort_values(by="Profit_Percentage", ascending=False, inplace=True)
